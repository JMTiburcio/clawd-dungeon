...
def run_sweep():
    ...
    variants = [
        ...
        ("1.3x  | 78/18  t=50",   (2,4),(5,8),(10,15),  78, 18, 1.3,  50),
        ("1.3x  | 85/19  t=50",   (2,4),(5,8),(10,15),  85, 19, 1.3,  50),
        ("1.3x  | 78/18  t=75",   (2,4),(5,8),(10,15),  78, 18, 1.3,  75),
        ("1.3x  | 85/19  t=75",   (2,4),(5,8),(10,15),  85, 19, 1.3,  75),
        ("1.3x  | 95/21  t=75",   (2,4),(5,8),(10,15),  95, 21, 1.3,  75),
        ("1.3x  | 78/18  t=100",  (2,4),(5,8),(10,15),  78, 18, 1.3, 100),
        ("1.3x  | 85/19  t=100",  (2,4),(5,8),(10,15),  85, 19, 1.3, 100),
        ("1.3x  | 95/21  t=100",  (2,4),(5,8),(10,15),  95, 21, 1.3, 100),
        ("1.3x  | 110/24 t=100",  (2,4),(5,8),(10,15), 110, 24, 1.3, 100),
        # ── 1.5x + fast XP: more turns to reach target ─────────────────
        ("1.5x  | 78/18  t=50  fast", (4,6),(8,12),(15,20),  78, 18, 1.5,  50),
        ("1.5x  | 85/19  t=50  fast", (4,6),(8,12),(15,20),  85, 19, 1.5,  50),
        ("1.5x  | 78/18  t=75  fast", (4,6),(8,12),(15,20),  78, 18, 1.5,  75),
        ("1.5x  | 85/19  t=75  fast", (4,6),(8,12),(15,20),  85, 19, 1.5,  75),
        ("1.5x  | 95/21  t=75  fast", (4,6),(8,12),(15,20),  95, 21, 1.5,  75),
        ("1.5x  | 110/24 t=75  fast", (4,6),(8,12),(15,20), 110, 24, 1.5,  75),
        ("1.5x  | 110/24 t=100 fast", (4,6),(8,12),(15,20), 110, 24, 1.5, 100),
    ]
